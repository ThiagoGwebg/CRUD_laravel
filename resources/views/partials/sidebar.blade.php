<aside class="sidebar">
    <div class="brand">
        ...
        <div>
            <div class="brand-name">Estoque</div>
    ...
    <a href="/produtos" class="nav-item {{ request()->is('produtos') ? 'active' : '' }}">
    ...
    <div class="sidebar-footer">
        ...
        <div class="user-info">
            <div class="user-name">Thiago</div>
            <div class="user-email">thiago@gwebg.com</div>
        </div>
    </div>
</aside>
